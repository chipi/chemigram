...
| **Phase 1.4** | `expressive-baseline` vocabulary authoring | **Mostly done (v1.4.0 in flight).** 31 of 35 entries authored programmatically by reverse-engineering darktable iop structs (see `docs/guides/expressive-baseline-authoring.md`); 22+ have e2e direction-of-change tests passing against real darktable. Remaining 4 (3 channelmixerrgb B&W in #63, 1 tone_equalizer-with-mask starter bug fix in #62) need hand-authored darktable seeds. |
