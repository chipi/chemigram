...
- `PA.md` — audiences, promises, principles. Every PRD anchors here.
- `PRD_TEMPLATE.md` — the format every PRD follows.
...
- Numbered sequentially (`PRD-NNN-slug.md`)
- Slug uses lowercase-hyphenated words
- Every PRD has a "Why this is a PRD" sentence in the header
- Every PRD anchors to PA via `PA/audiences/...`, `PA/promises/...`, `PA/principles/...`
- Drafts don't promise dates or sequencing — those are planning concerns, not PRD content
