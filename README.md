...
| 1 | Core engine + MCP server + starter vocabulary | In progress — Slice 1 at 4/5 (parser, XMP r/w, synthesizer, render pipeline shipped; RFC-001 + RFC-005 + RFC-006 closed) |
