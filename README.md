...
| 1 | Core engine + MCP server + starter vocabulary | In progress — Slice 1 (v0.1.0) and Slice 2 (v0.2.0) shipped; 6 of 17 RFCs closed (RFC-001/002/003/005/006/015 → ADR-050..055). Slice 3 (MCP server) is next. |
