...
| 1 | Core engine + MCP server + starter vocabulary | In progress — Slice 1 components complete (parser, XMP r/w, synthesizer, render pipeline, EXIF binding all shipped; all 4 Slice 1 RFCs closed) |
